...
The code, and the Kaggle notebook I'll make mention of later, are both here: <https://github.com/patimus-prime/rnaseq_her2>. I wrote this in a pretty relaxed tone given this was a coding challenge. My Master's thesis is available at my GitHub for an example of more uh, academic/working-level writing.
